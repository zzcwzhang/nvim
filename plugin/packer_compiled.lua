...
_G.packer_plugins = {
  ["ChatGPT.nvim"] = {
    ...
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/ChatGPT.nvim",
    url = "https://github.com/zzcwzhang/ChatGPT.nvim"
  },
  ["bufferline.nvim"] = {
    loaded = true,
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/vim-vsnip",
